...
from ng_rdm.components import Col, Row, Button, Dialog
...
class VerifyMfaStep(StepCard):
    ...
    async def act(self) -> StepResult | None:
        ...
        return StepResult('completed', output={'acr': self.acr_value})
    ...
    def render_enabled(self, state: dict) -> None:
        ...
        Button(_(self.primary_button_label), on_click=dialog.open).style('margin-top: 0.5rem;')
