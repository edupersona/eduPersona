...
translations: dict[str, dict[str, str]] = {
    'nl_nl': {
        ...
        'Guests': 'gasten',
        'Must be an @edupersona.nl email address (for this PoC)': 'moet een @edupersona.nl mailadres zijn (voor deze PoC)',
        ...
        'code': 'code',
        'Code': 'code',
        'Collected facts': 'verzamelde gegevens',
        ...
        'Invitation parameters': 'parameters voor uitnodiging',
        'Invitation email': 'uitnodiging (mail)',
        'Invitation sent': 'uitnodiging verstuurd',
        'Invited': 'uitgenodigd',
        'invited': 'uitgenodigd',
        'Invited at': 'uitgenodigd op',
        "Invite sender's mail address (POC: name@edupersona.nl)": 'afzender van uitnodiging (POC: naam@edupersona.nl)',
