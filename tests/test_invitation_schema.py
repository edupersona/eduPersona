...
async def test_persona_columns_persist(test_tenant):
    inv = await Invitation.create(
        ...
        persona_key="gastdocent", guest_id="EMP-42",
    ...
    assert fetched.guest_id == "EMP-42"
